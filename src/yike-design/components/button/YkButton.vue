<template>
  <div :class=" { disabled: disabled,loading:loading }" :style="{ width: long ? '100%' : 'auto' }" class="yk-buttons">
  <div class="yk-button" :class="[type, size, btStatus(status)]" :style="{ width: long ? '100%' : 'auto' }">
