<template>
  <yk-space direction="vertical">
    ...
    <yk-input style="width: 360px" clearable>
    ...
    <yk-input placeholder="输入总金额" style="width: 360px" size="m">
      <template #prefix>
        <IconMoneyOutline />
      </template>
    </yk-input>
    <yk-input placeholder="输入总金额" style="width: 360px">
      <template #prefix>
        <IconMoneyOutline />
      </template>
    </yk-input>
    <yk-input placeholder="输入总金额" style="width: 360px" size="xl">
      <template #prefix>
        <IconMoneyOutline />
      </template>
    </yk-input>
    <yk-input placeholder="请输入你最喜欢的书" style="width: 360px">
      <template #suffix>
        <IconBookmarkOutline />
      </template>
    </yk-input>
