...
function getSvgIconHTML(path: string) {
  const carry = path.split('yike-design-dev').pop()
  return svgIconBucket[`..${carry}`]
}

console.log(svgIconBucket)
