...
import { render } from '@yike/utils'
import '../style'
import { YkButton, YkSpace } from '@yike/components'
import IconReminderFill from '@yike/components/svg-icon/icon-reminder-fill'
import IconWarningFill from '@yike/components/svg-icon/icon-warning-fill'
import IconCrossFill from '@yike/components/svg-icon/icon-cross-fill'
import IconTickFill from '@yike/components/svg-icon/icon-tick-fill'
import IconLoadingOutline from '@yike/components/svg-icon/icon-loading-outline'
import IconCloseOutline from '@yike/components/svg-icon/icon-close-outline'
